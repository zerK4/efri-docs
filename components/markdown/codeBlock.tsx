...
export default function CodeBlock({
  ...
  return (
    <div className='relative group/codeBlock my-4 dark:bg-codeBackground w-full bg-neutral-50 rounded-xl border dark:border-neutral-800 border-neutral-200 overflow-hidden'>
      {title && (
        <div className='flex relative items-center px-4 py-2 h-12 justify-between bg-neutral-50 dark:bg-codeBackground border-b dark:border-neutral-800 border-neutral-200'>
      ...
      {!title && (
        <div className='absolute z-10 right-2 top-2 group-hover/codeBlock:opacity-100 opacity-0'>
          <Copy content={raw ?? (children as string)} />
        </div>
      )}
      <div className='px-4'>
