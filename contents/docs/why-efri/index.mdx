...
You don't need an ORM to play with the database, it got you covered with the built-in models and with the specially designed ORM.

You don't need to chain routes like `router.get('/users').get('/{user}')`(i find this a pain) by default, 
it got you covered with the built-in router.
